...
double Entropy(int num_pos, int num_neg) {
  ...
  double num_pos_doub = (double) num_pos;
  double num_neg_doub = (double) num_neg;
  double sum = num_pos+num_neg;
  entropy = LogBase2(sum/num_pos_doub)*num_pos_doub/sum +
            LogBase2(sum/num_neg_doub)*num_neg_doub/sum;
